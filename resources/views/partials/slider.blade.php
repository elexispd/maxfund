    ...
    <div class="swiper sc-slider-2">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="slide-image sc-image-layer" style="background-image: url('assets/images/project/max5.jpg');"></div>
          <div class="container position-relative">
            <div class="sc-slider-content p-z-idex">
                ...
                <h1 class="slider-title white-color sc-mb-25 sc-sm-mb-15" >
                    Let Maxfund help you achieve your financial goals
                </h1>
                ...
                <div class="slider-btn-area d-flex align-items-center">
                    <div class="sc-slider-btn">
                        <a class="sc-primary-btn p-z-idex2" href="{{route('register')}}"> Get Started</a>
                    </div>
                </div>
            </div>
          </div>
        ...
        <!-- Slide 2 -->
        <div class="swiper-slide">
          <div class="slide-image sc-image-layer" style="background-image: url('assets/images/project/max2.jpg');"></div>
          <div class="container position-relative">
            <div class="sc-slider-content p-z-idex">
                <div class="sc-slider-subtitle" >Diversify your portfolio</div>
                <h1 class="slider-title white-color sc-mb-25 sc-sm-mb-15" >
                     Explore a wide range of investment options with Maxfund                                </h1>
                <div class="slider-desc white-dark-color sc-mb-40 sc-sm-mb-25 ">
        ...
        <!-- Slide 3 -->
        <div class="swiper-slide">
          <div class="slide-image sc-image-layer" style="background-image: url('assets/images/project/choose-bg.jpg');"></div>
          <div class="container position-relative">
            <div class="sc-slider-content p-z-idex">
                <div class="sc-slider-subtitle" >Personalized investment solutions</div>
                <h1 class="slider-title white-color sc-mb-25 sc-sm-mb-15">
                    Let Maxfund help you create a personalized investment strategy
                </h1>
                <div class="slider-desc white-dark-color sc-mb-40 sc-sm-mb-25">
