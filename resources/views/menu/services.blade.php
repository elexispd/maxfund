...
@include('partials.navbar')
        ...
        <!--========== Header Section End ==============--><!--=========== breadcrumb Section Start =========-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sc-slider-content p-z-idex">
                            ...
                            <h1 class="slider-title white-color sc-mb-25 sc-sm-mb-15">Our services</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="service-details-content">
                        ...
                        <p>
							One of the key benefits of our investment loan is that it allows our clients to access funds without having to liquidate their existing investments. This means that you can continue to earn returns on your existing portfolio while also taking advantage of new investment opportunities.
						</p>
                        <p>
							Our investment loan also provides a range of tax benefits for eligible clients, which can help to reduce your overall tax liability and improve your returns.
						</p>
                        <p>
							...
							<p>Our individual retirement accounts (IRAs) provide you with a tax-advantaged way to save for retirement. We offer traditional, Roth, and SEP IRAs, and our investment experts can help you choose the best investment options to maximize your returns and meet your retirement goals.</p>
                        ...
                        <ul>
							<p>
								We offer stocks trading for a variety of popular companies, including:
						...
						<ul>
							<li>
								US Treasury bonds: These bonds are issued by the US government and are considered to be among the safest investments available. They provide a fixed rate of interest and are typically issued with maturities ranging from 1 to 30 years.
							</li>
							<li>
								Corporate bonds: These bonds are issued by corporations and provide investors with a higher rate of interest than US Treasury bonds. However, they also carry a higher degree of risk, as the creditworthiness of the issuer can affect the value of the bond.
							</li>
							<li>
								Municipal bonds: These bonds are issued by state and local governments and are exempt from federal income tax. They can be a good option for investors seeking tax-advantaged income.
							</li>

						</ul>

						<p>
							Bond indices are benchmarks that track the performance of a portfolio of bonds. They are constructed based on certain criteria such as issuer, credit rating, maturity, and sector. By comparing their own bond portfolios to a relevant bond index, investors can assess whether they are outperforming or underperforming the market, and adjust their investment strategies accordingly.
						</p>
						...
						<ul>
							<li>Commercial REIT: This REIT invests in commercial real estate assets, such as office buildings, warehouses, and shopping centers. It provides a stable income stream from long-term leases and the potential for capital appreciation as property values increase. </li>
							<li>Residential REIT: This REIT invests in residential real estate assets, such as apartment buildings and single-family homes. It provides a stable income stream from rental income and the potential for capital appreciation as property values increase. </li>
							<li>Healthcare REIT: This REIT invests in healthcare-related real estate assets, such as hospitals, medical offices, and senior living facilities. It provides a stable income stream from long-term leases and the potential for capital appreciation as demand for healthcare services increases. </li>
							<li>International REIT: This REIT invests in real estate assets outside of the United States, providing exposure to international markets and diversification benefits. It may invest in a variety of real estate sectors, such as commercial, residential, or hospitality. </li>
							<li>Mortgage REIT: This REIT invests in mortgages and other debt securities backed by real estate assets, providing a stable income stream from interest payments. It may invest in a variety of mortgage types, such as residential or commercial mortgages. </li>
						...
						<ul>
							...
							<li>Euro FX Futures</li>
							<li>Natural Gas Futures</li>
							<li>Bitcoin Futures</li>
							<li>Ethereum Futures</li>
							<li>Litecoin Futures</li>
							<li>Ripple Futures</li>
