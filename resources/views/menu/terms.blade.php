...
<!-- Mirrored from creedprofitalliance.com/terms by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Apr 2025 09:14:44 GMT -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sc-slider-content p-z-idex">
                            <div class="sc-slider-subtitle">Home - Our TERMS</div>
                            <h1 class="slider-title white-color sc-mb-25 sc-sm-mb-15">Our TERMS</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="jumbotron">
			...
			<br/>
				...
				<p>
					...
					By using this website, you agree to be bound by these terms and conditions. If you have any questions or concerns about these terms and conditions, please contact us.
				<p>
			...
			<div class="container" id="privacy">
				...
				<li>Financial information such as bank account or credit card information</li>
				...
				<h3>Security</h3>
				<p>We take reasonable measures to protect your information from unauthorized access, use, or disclosure. However, we cannot guarantee the security of your information.</p>
				<h3>Cookies</h3>
				...
				<p>We reserve the right to modify this policy at any time. Changes will be posted on our website.</p>
				<h3>Contact us</h3>
				<p>If you have any questions or concerns about our privacy policy, please contact us at the following:</p>
				<ul>
				<li>Email: <a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="b5dcdbd3daf5d6c7d0d0d1c5c7dad3dcc1d4d9d9dcd4dbd6d09bd6dad8">[email&#160;protected]</a></li>
				<li>Phone: </li>
				</ul>
			</div>
		</section>
